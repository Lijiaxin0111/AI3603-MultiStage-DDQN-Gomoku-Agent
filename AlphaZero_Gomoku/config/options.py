...
parser.add_argument("--play_batch_size", type=int, default=2, help="The time of selfplaying when collect the data")
...
parser.add_argument("--temp_exp", type=bool, default=False,
                    help="whether to use the temperature expotential decrease parameter to control the exploration")
parser.add_argument("--new_net", type=bool, default=False)
# MCTSPlayer setting
...
parser.add_argument("--mood", type=int, default=0,
                    help="the test mood:=  0: Alphazero Vs Pure;  1: Gumbel_Alphazero Vs Pure; 2:Alphazero Vs Gumbel_Alphazero  ")

# Alphazero  agent setting
parser.add_argument("--temp", type=float, default=1.0,
                    help="the temperature parameter when calculate the decision function getting the next action")
